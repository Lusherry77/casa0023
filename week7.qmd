...
This matched the supervised workflow described in Jensen (2015, Ch. 9), where classification depends heavily on representative training data. Even small spatial bias in our samples—like too few water points—led to frequent misclassification.
...
Unsupervised methods like K-means are useful in data-scarce settings, but hard to interpret. Jensen (2015, Ch. 10) also describes “expert systems” that embed domain logic into classification—suggesting potential for hybrid models.
